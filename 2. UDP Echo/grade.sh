...
declare -A file_arr
file_arr=(
    ["iactuallytestedthis-upd_echo.png"]="PNG image data"
...
custom_test_1() {
    ...
    python3 fake_wrapper.py localhost 12000 10 1 >custom_tests/outputs/t1.out
...
custom_test_2() {
    custom_test_score=0
    python3 fake_wrapper.py localhost 12000 12 2 >custom_tests/outputs/t2.out
